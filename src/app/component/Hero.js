            ...
            <div className="container">
                <div className="content-wrap text-center text-white">
                    ...
                    <div className="title text-display-2 effectFade fadeRotateX">
                        <h1><span className="title1 fw-semibold text-gradient-1">Websites That Win. </span>
                            <br />
                            <div className="title2 d-flex gap-20 justify-content-center flex-wrap">
                                <span className="fw-semibold text-gradient-1">Brands That Stick.</span>
                            </div>
                        </h1>
                    </div>
                    <p className="text effectFade fadeUp">
                        We craft strategic web experiences, memorable logos, and cohesive brand identities,<br /> built
                        with
