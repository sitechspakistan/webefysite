...
export default function PortfolioDet({ param }) {

    const project = porfoliodata.find(
    ...
    return (
        ...
        //                     <a href="#" className="tags-item fw-semibold">Data cleaning</a>
        //                     <a href="#" className="tags-item fw-semibold">Embeddings</a>
        //                 </div>
        //             </div>
        ...
        //                     <a href="#" className="tags-item fw-semibold">Ecommerce/Retail</a>
        //                 </div>
        //             </div>
        //         </div>
        //         <div className="row mb-60">
