        ...
        <div className="section-features flat-spacing pt-0 pb-0">
            <div className="container">
                <div className="heading-section center mb-64">
                    <h2 className="heading-title text-gradient-3 effectFade fadeRotateX">Automations We Build</h2>
                    ...
                    {automations.map((item, index) => (
                        ...
                        >
                            <div className="features-item style-2 h-100 text-center effectFade fadeRotateX">
                                <div
                                    className="icon " id={item.color}
                                    style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', margin: "0px auto" }}
                                >
                                    {item.icon}
                                </div>
