...
const ProductFrom = () => {
    ...
    return (
        <section id='product-form' className="section-hero bg-white">
...
//     <div className="section-contact product-form">
...
//                             <div className="col-lg-4 custom-phone-input">
//                                 <fieldset className="mb-21">
//                                     <label className="fw-semibold text-body-3 mb-20">
//                                         Your Phone Number
//                                     </label>
...
//                                         <option value="Website careRestaurant">Website Care</option>
//                                     </select>
//                                 </fieldset>
//                             </div> */}
//                             <fieldset className="mb-18">
