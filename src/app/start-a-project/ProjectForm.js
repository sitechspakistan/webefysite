                                ...
                                <div className="col-left p-0">
                                    <div className="mb-24">
                                        ...
                                        <p className="text effectFade fadeUp">
                                            Your Next Big Project Starts Here. Tell us about your
                                            goals, and we'll craft a strategy tailored to your
                                            business. From design to development to automation we
                                            build it all.
                                        </p>
                                    </div>
                                    ...
                                    <div className="tf-social-1 gap-24 effectFade fadeRotateX">
                                        ...
                                        <a href="https://x.com/webefytoday"
                                            target="_blank"
                                        ...
                                        <a href="https://www.facebook.com/webefytoday/"
                                            target="_blank"
                                            className="text-body-1 fw-semibold"
                                        >
                                            Facebook
                                        ...
                                        <a href="https://www.instagram.com/webefytoday/" target="_blank" className="text-body-1 fw-semibold">
                                            Instagram
                                            <div className="social-item">
