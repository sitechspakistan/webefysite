...
export default function sitemap() {
    ...
    const staticPages = [
        ...
        { url: `${baseUrl}/solutions`, lastModified: currentDate, priority: 0.9 },
        { url: `${baseUrl}/solutions/ai-booking-agent`, lastModified: currentDate, priority: 0.8 },
        { url: `${baseUrl}/solutions/business-automation`, lastModified: currentDate, priority: 0.8 },
        { url: `${baseUrl}/solutions/restaurant-management`, lastModified: currentDate, priority: 0.8 },
