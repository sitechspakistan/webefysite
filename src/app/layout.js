...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <head>
        <link rel="shortcut icon" href="assets/images/webefy-lgo/about-shape1_2.png" />
        <link rel="apple-touch-icon-precomposed" href="assets/images/logo/favicon.svg" /></head>
      <body className="counter-scroll">
        ...
        <Script src="/assets/jquery.nice-select.min.js" strategy="afterInteractive" />
        ...
        <Script src="/assets/ScrollToPlugin.min.js" strategy="afterInteractive" />

        <Script
          src="/assets/gsapAnimation.js"
