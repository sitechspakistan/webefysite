...
export const metadata = {
    title: "Website Development Company in San Francisco, CA | YourCompany",
    description: "We build high-performance websites that help San Francisco businesses attract more customers, rank higher on Google, and grow faster online.",
}
...
const businessStats = [
    {
        title: "150+",
        desc: "San Francisco Businesses Served: Trusted by local companies across the DFW area.",
        Icon: MapPin,
        color: "#4A90D9",
        txtcolor: "#4A90D9",
        bg: "#EAF3FC",
    ...
    {
        title: "45%",
        desc: "Average Growth: San Francisco clients see measurable growth after automating operations.",
        Icon: TrendingUp,
        color: "#7B5BD9",
        bg: "#F1EAFC",
        txtcolor: "#7B5BD9",
    ...
    {
        title: "500+",
        desc: "Local Team Members Supported: Helping San Francisco teams work smarter, not harder.",
        Icon: Users,
        color: "#D94FA0",
        bg: "#FCEAF5",
        txtcolor: "#D94FA0",
    ...
    {
        title: "4.9/5",
        desc: "Client Satisfaction: Rated highly by San Francisco business owners for reliability and support.",
        Icon: Star,
        color: "#2ECC71",
        bg: "#E9FBF1",
        txtcolor: "#2ECC71",
...
const SanFrancisco = () => {
    return (
        <>
            <HeroForm
                subheading={"San Francisco, CA"} heading={"San Francisco, CA"} desccityname={"San Francisco"}
            />
            <WebDevSlider />
            <PerfectIndustry
                industries={industries}
                heading="Website Development For Every Industry In San Francisco"
            ...
            <HomePortfolio />
            <BusinessWithUs
                heading="Helping San Francisco Businesses Succeed Online"
